                          ...
                          children: [
                            ...
                            Card(
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                    "Aquí podrás ver un resumen de tu tatuaje más el tiempo y el presupuesto estimados",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5),
                        Align( alignment: Alignment.centerLeft, child: Text("TAMAÑO: " + widget.userCont.userLogged.tattooOnCreated.size + "cm²") ),
                        SizedBox(height: 5),
  ...
  Future<void> _enviar(User user) async {
    Email email = Email(
      body: "Usuario: ${user.email}\n"
          ...
          "Tamaño: ${user.tattooOnCreated.size}\n"
